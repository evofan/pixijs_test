...
let setPixi = function() {
  ...
  */
  ...
  // しかし、hitTestRectangle()関数はどうでしょうか。
  // それは何をし、そしてそれはどのように機能しますか？
  // このような衝突検出アルゴリズムがどのように機能するかの詳細は、このチュートリアルの範囲外です。
  // 本当に知りたいのなら、この本の使い方を知ることができます）
  // 最も重要なことは、あなたがそれをどのように使うかを知っているということです。
  // しかし、参考のために、そして興味がある場合には、ここに完全なhitTestRectangle()関数定義があります。
  // あなたはコメントからそれがしていることを理解することができますか？
